...
export default class ForgetPass extends Component {
    ...
    _forgetpass365 = () => {
        if(this.state.email == ''){
          ...
          axios.get(`${this.state.settings.base_url}Api/password_recovery?email=${this.state.email}`)
            .then( res  => {
        ...
        <Content style={{backgroundColor:'#F9F9F9'}}>
          ...
          <View style={{width:'94%', marginLeft:'3%'}}>
            ...
            <TouchableOpacity 
              ...
              <Text style={styles.logintext}>{this.state.settings.continue}</Text>
            </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    logintext:{
    fontFamily: 'AMontserrat-SemiBold',
    color:'#ffffff', 
    fontSize:16,
    paddingVertical:8,
    },
