...
export default class JourneyDetails extends Component {
  ...
  componentDidMount = () =>{
          ...
          axios.get(`http://moveit.ellixar.com/Api/search?start_point=${this.state.data.startPointVal}&end_point=${this.state.data.endPointVal}&date=${this.state.data.chosenDate}&fleet_type=${this.state.data.fleetsData}`)
            .then(res => {
                this.setState({
                    ...this.state,
...
export default class SeatPlan extends Component {
    ...
    _getSeatPan = () => {
        axios.get(`http://moveit.ellixar.com/Api/findBookingInformation?route=${this.state.data.route}&trip_id_no=${this.state.data.trip_id_no}&booking_date=${this.state.day}&type=${this.state.fleetType}`)
            .then(res => {
