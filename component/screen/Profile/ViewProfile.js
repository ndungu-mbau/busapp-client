...
export default class ViewProfile extends Component {
    ...
    _viewPro = () =>{
            return <View>
                ...
                <View style={{width:'100%' , height:170, backgroundColor:'#0288D1', justifyContent:'center', alignItems:'center', opacity: .8}}>
                    <View style={{width:90, height:90, borderRadius:50, backgroundColor:'#fff', justifyContent:'center', alignItems:'center'}}>
                        {
                            (this.state.userDa.image == null) ? 
                            <Thumbnail large source={require('../../assets/no-profile.png')} />
                            :
                    ...
                    <View style={{position:'absolute', top:5, left:15}}>
                        ...
                        <Icon style={{color:'#fff', fontFamily:'Montserrat-SemiBold'}} name='arrow-back' />
                        </TouchableOpacity>
                    </View>
                </View>
