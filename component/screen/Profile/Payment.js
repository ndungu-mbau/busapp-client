...
import { Text, StyleSheet, View, Image, TouchableOpacity, ScrollView, Dimensions, AsyncStorage } from 'react-native'
  ...
  render() {
    return (
            ...
            <Body>
                <View style={styles.logoD}>
                    <Image
                        ...
                        source={{uri: this.state.allDataInfo.allinfoData.data.infodata.data.logo}}
                    />
                </View>
            </Body>
        ...
        <View style={[styles.searchtour,{flexDirection:'row'}]}>
            ...
            <View style={{flex:2}}>
                        <Button transparent onPress={()=> this.props.navigation.navigate('passenger')}>
                                <Icon style={{color:'#fff'}} name='arrow-back' />
                            </Button>
                          </View>
                          <View style={{flex:14}}>
                          <Text style={[styles.searchtourtext]}>{this.state.settings.select_your_payment_method}</Text>
                        </View>
        ...
        <ScrollView>
            ...
            <View style={styles.AllDataVal}>
                <View style={{marginBottom:10}}>
                    ...
                    <TouchableOpacity
                    onPress={()=> this.props.navigation.navigate('paycash', {allData : this.state,settings : this.state.settings})}
                    style={{borderWidth:2, borderColor:'#e3e3e3',paddingHorizontal:10, paddingVertical:10, marginBottom:20}}>
